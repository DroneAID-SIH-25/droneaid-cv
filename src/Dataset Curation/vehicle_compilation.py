...
# Source dataset
source_dataset = r"E:\1_Work_Files\13_Project - DroneAID\Datasets\vehicle dataset"
...
original_classes = ['car', 'threewheel', 'bus', 'truck', 'motorbike', 'van']
...
print("Vehicle dataset successfully merged into compiled_dataset!")
